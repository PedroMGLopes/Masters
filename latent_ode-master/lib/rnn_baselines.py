...
class Classic_RNN(Baseline):
	...
	def forwardextrap(self, time_steps_to_predict, initial_hidden,last_cell_output, mask = None, n_traj_samples = 1, mode = None):
		...
		hidden_state, all_hiddens = run_rnn(last_cell_output, delta_ts, first_hidden=initial_hidden,
		...
		extra_info["last_hidden"]=hidden_state
